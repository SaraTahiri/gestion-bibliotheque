    ...
    public void updateTableData() {
        ...
        for (Retour retour : retours) {
            tableModel.addRow(new Object[]{
                ...
                retour.getDateRetourEffective() != null ? retour.getDateRetourEffective().toString() : "Non définie",
    ...
    private void calculerPenalite() {
        try {
            ...
            if (dateRetourEffective.isBefore(dateRetourPrevue) || dateRetourEffective.isEqual(dateRetourPrevue)) {
                ...
                retour.setDateRetourEffective(dateRetourEffective);
                retourModel.modifierRetour(idEmprunt, dateRetourEffective);
                vue.setValueAt(selectedRow, 6, dateRetourEffective.toString()); // Mettre à jour la date retour effective
                ...
                retour.setDateRetourEffective(dateRetourEffective);
                retourModel.modifierRetour(idEmprunt, dateRetourEffective);
                vue.setValueAt(selectedRow, 5, dateRetourEffective.toString()); // Mettre à jour la date retour effective
